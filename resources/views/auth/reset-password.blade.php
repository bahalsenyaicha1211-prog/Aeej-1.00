<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required autofocus autocomplete="new-password" minlength="8" />
            <p style="font-size:12px; color:var(--text-dim); margin-top:6px;">Minimum 8 caractères, avec une majuscule, une minuscule et un chiffre.</p>
